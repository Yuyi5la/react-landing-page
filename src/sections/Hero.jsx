...
const Hero = () => {
  return (
    <section id="home" className="relative bg-black text-white px-6 py-40 md:py-52 overflow-hidden z-10 min-h-screen flex items-center">
      ...
      <div className="relative z-10 max-w-4xl md:mt-20">
        ...
        <div className="flex flex-wrap gap-4">
          <a
             href="https://example.com" //login link 
             target="_blank"
